...
class Config(object):
    ...
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "34817fe096f567f55ce37750b8a5ff1b")
    ...
    TECH_VJ_DATABASE_URL = os.environ.get("TECH_VJ_DATABASE_URL", "mongodb+srv://ppspsksks:ppspsksks@cluster0.wxo2jdw.mongodb.net/?retryWrites=true&w=majority")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "-1002007429854")) # your log channel id and make bot admin in log channel with full right 
